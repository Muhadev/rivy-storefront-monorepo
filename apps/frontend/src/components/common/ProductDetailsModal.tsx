...
export function ProductDetailsModal({ product, open, onOpenChange, debug }: ProductDetailsModalProps) {
  ...
  return (
    ...
    >
      {/* Main Content: show either product details or reviews */}
      {!showReviews ? (
        ...
        <div className="overflow-y-auto pb-24" style={{ maxHeight: '75vh' }}>
    <ReviewsList productId={product.id} />
        </div>
      )}

      {/* Sticky Add to Cart and Review Button */}
      <div className="fixed left-0 right-0 bottom-0 z-50 p-4 bg-white border-t border-gray-200 flex justify-center gap-4">
        {!isOutOfStock ? (
          <Button
